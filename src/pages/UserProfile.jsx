import { FormDialog, ListActionButton, NavigationMenu, PageContainer, Section } from '@components'
...
const UserProfilePage = () => {
  ...
  const generatePersonalData = (data) => [
    ...
    },
    {
      ...
      field: 'specialty',
      icon: (color) => <LocalHospitalIcon color={color} />,
      plural: false
    },
    {
      name: 'Teléfono',
      value: data?.phone,
      field: 'phone',
      icon: (color) => <CallIcon color={color} />,
      plural: false
    },
    {
  ...
  const handleClickOpenFormDialog = (dialog) => () => {
    ...
    <PageContainer>
      ...
      >
        <Stack spacing="2rem" alignItems="center">
          ...
          <List sx={{ width: '100%' }}>
            {personalData?.map(({ icon, value, name, field }) => {
