...
export const markdownToHtml = (data) => {
  if (data) {
    return marked
      .parse(data, { mangle: false, headerIds: false })
      .replaceAll(
        '<h6>',
        "<h6 style=\"margin: 0; font-family: 'Roboto','Helvetica','Arial',sans-serif; line-height: 1.75; letter-spacing: 0.00938em; font-size: 1.15rem; font-weight: 500;\">"
      )
  }
  return ''
}
